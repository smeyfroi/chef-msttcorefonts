...
execute "enable multiverse" do
  command "apt-add-repository 'deb http://security.ubuntu.com/ubuntu precise multiverse'"
  command "apt-add-repository 'deb http://security.ubuntu.com/ubuntu precise-updates multiverse'"
